...
若存在范围 [first1, last1) 中元素的排列，使得该范围等于 [first2,last2) ，则返回 true ，
    若不给出，则其中 last2 代表 first2 + (last1 - first1) 。
...
然而，若 ForwardIt1 和 ForwardIt2 满足随机访问迭代器 (RandomAccessIterator) 
    的要求且 std::distance(first1, last1) != std::distance(first2, last2) ，则不应用谓词。
